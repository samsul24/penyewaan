...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $this->db->get_where('data_sewa', array('status' => 'disetujui', 'id_lapangan' => 2))->num_rows() ?>
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body border-bottom-primary">
            ...
            <form method="post" action="<?= base_url('admin/sewa/filter2'); ?>">
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="<?php echo base_url("admin/sewa/sewa2"); ?>" class="btn btn-success"> <i class="fas fa-sync-alt"></i>&nbsp; </a>
                    </div>
                        ...
                        foreach ($sewa as $row) : ?>
                            <tr>
                                ...
                                <td style=" text-align: center;">
                                    ...
                                    <a href="#modalDelete" data-toggle="modal" onclick="$('#modalDelete #formDelete').attr('action', '<?= site_url('admin/sewa/hapus_process2/' . $row['id_sewa']) ?>')" class='btn btn-circle btn-danger'>
                            ...
                            <div id="ubah-sewa-<?php echo $row['id_sewa'] ?>" class="modal fade" tabindex="-1">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo base_url('admin/sewa/ubah_process2/' . $row['id_sewa']) ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card card-primary shadow-sm border-bottom-primary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url("admin/sewa/filterLaporanLapangan2"); ?>" method="POST" target='_blank'>
