        ...
        <div id="content-container">
            ...
            <div id="page-head">
                ...
                <div class="text-center">
                    <h3>Data Lapangan 1.</h3>
                    <p>Merekap secara keseluruhan data sewa lapangan 1 </p>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url('admin/lapangan/hapus_process/' . $row['id_sewa']) ?>" class="btn btn-icon" onclick="return confirm('Apakah anda yakin ingin menghapus lapangan <?php echo $row['nama_lapangan'] ?>')"><i class="ti-trash"></i></a>
                                                    </td>
                                                </tr>
